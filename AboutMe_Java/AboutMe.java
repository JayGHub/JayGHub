...
public class AboutMe {
    ...
    public static void main(String[] args) {
        ...
        while (!done) {
            System.out.print("What would you like to know about me? All spaces must be replaced by underscore");
            String question = input.next();
            while (!found) {
                found = true;
                switch (question) {
                    case "Name": message = "My name is Joshua Green"; break;
                    ...
                    case "Age": message = "I am 18 years old"; break;
                    ...
                    case "help": message = "Name, Age, Birthday, Number, Sexuality, Status, Discord, Discord_Server, Snapchat, YouTube"; break;
